...
make udp-server.cooja TARGET=cooja</commands>
    ...
    <motetype>
      ...
      <source>[CONFIG_DIR]/mitigation/rpl-dio-replay-mitigation.c</source>
      <commands>make clean TARGET=cooja
make rpl-dio-replay-mitigation.cooja TARGET=cooja</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
...
make rpl-dio-attacker.cooja TARGET=cooja</commands>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>0.40376395722461456 0.0 0.0 0.40376395722461456 74.00667306958522 297.7608164273528</viewport>
    </plugin_config>
  ...
  <plugin>
    ...
    <bounds x="0" y="400" height="300" width="800" z="2" />
  </plugin>
  <plugin>
    org.contikios.cooja.plugins.LogListener
    <plugin_config>
    ...
    <bounds x="0" y="0" height="942" width="2091" />
  </plugin>
  <plugin>
  ...
  <plugin>
    ...
    <bounds x="974" y="402" height="300" width="500" z="1" />
  </plugin>
  <plugin>
...
log.testOK();</script>
    ...
    <bounds x="1491" y="2" height="700" width="600" z="3" />
  </plugin>
</simconf>
