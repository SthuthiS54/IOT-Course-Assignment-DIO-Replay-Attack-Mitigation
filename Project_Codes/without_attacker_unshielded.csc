...
make rpl-dio-evaluator.cooja TARGET=cooja</commands>
  ...
  <plugin>
    ...
    <bounds x="280" y="0" height="400" width="400" z="2" />
  </plugin>
  <plugin>
    ...
    <bounds x="0" y="400" height="300" width="800" z="3" />
  </plugin>
  <plugin>
    org.contikios.cooja.plugins.LogListener
    <plugin_config>
    ...
    <bounds x="680" y="0" height="250" width="800" z="5" />
  </plugin>
  <plugin>
    ...
    <bounds x="680" y="400" height="300" width="350" z="4" />
  </plugin>
  <plugin>
    ...
    <bounds x="1030" y="400" height="300" width="500" z="1" />
  </plugin>
  <plugin>
...
log.testOK();</script>
    ...
    <bounds x="1530" y="0" height="700" width="600" />
  </plugin>
</simconf>
